...
Singleton {
    ...
    property var themeColors: [
        ...
        ["Nord Frost", "#2E3440", "#ECEFF4", "#AEB8C7", "#D8DEE9", "#8FBCBB", "#81A1C1", "#88C0D0", "#402E3440", "#88C0D0", "#81A1C1", "#A3BE8C"],
        ["Polar Night", "#242933", "#E5E9F0", "#9AA4B2", "#C8D0DC", "#81A1C1", "#88C0D0", "#8FBCBB", "#40242933", "#88C0D0", "#81A1C1", "#A3BE8C"],
        ["Blue Steel", "#202833", "#DCE6F2", "#8B9BAD", "#B8C7D9", "#8CB4D8", "#6FA8DC", "#91C4E8", "#40202833", "#8CB4D8", "#6FA8DC", "#9BCB8B"],
        ["Deep Ocean", "#0D1B24", "#D6E5EA", "#78909C", "#B0C4CC", "#5FB3B3", "#4FA3D1", "#72C7D9", "#400D1B24", "#5FB3B3", "#4FA3D1", "#9CCC65"],
        ["Aurora", "#182027", "#DCE7E5", "#899B99", "#B9CCC7", "#A3BE8C", "#88C0D0", "#B48EAD", "#40182027", "#8FBCBB", "#88C0D0", "#A3BE8C"],
        ["Catppuccin Mocha", "#1E1E2E", "#CDD6F4", "#A6ADC8", "#BAC2DE", "#F5E0E8", "#89B4FA", "#B4BEFE", "#401E1E2E", "#89DCEB", "#89B4FA", "#A6E3A1"],
        ["Tokyo Night", "#1A1B26", "#C0CAF5", "#9AA5CE", "#A9B1D6", "#BB9AF7", "#7AA2F7", "#89DDFF", "#401A1B26", "#7DCFFF", "#7AA2F7", "#9ECE6A"],
        ["Dracula", "#282A36", "#F8F8F2", "#BFBFBF", "#F8F8F2", "#8BE9FD", "#BD93F9", "#FF79C6", "#40282A36", "#8BE9FD", "#50FA7B", "#F1FA8C"],
        ["Gruvbox", "#282828", "#EBDBB2", "#A89984", "#D5C4A1", "#FBF1C7", "#83A598", "#8EC07C", "#40282828", "#83C07C", "#83A598", "#B8BB26"],
        ["Rose Pine", "#191724", "#E0DEF4", "#908CAA", "#E0DEF4", "#F6C177", "#C4A7E7", "#EBBCBA", "#40191724", "#9CCFD8", "#C4A7E7", "#9CCFD8"],
        ["Everforest", "#2D353B", "#D3C6AA", "#9DA9A0", "#D3C6AA", "#A7C080", "#A7C080", "#83C092", "#402D353B", "#83C092", "#7FBBB3", "#A7C080"],
        ["One Dark", "#282C34", "#ABB2BF", "#7F848E", "#ABB2BF", "#D19A66", "#61AFEF", "#C678DD", "#40282C34", "#56B6C2", "#61AFEF", "#98C379"],
        ["Kanagawa", "#1F1F28", "#DCD7BA", "#727169", "#C8C093", "#98BB6C", "#7E9CD8", "#7FB4CA", "#401F1F28", "#7AA89F", "#7E9CD8", "#98BB6C"],
        ["Nord Aurora", "#3B4252", "#ECEFF4", "#D8DEE9", "#E5E9F0", "#A3BE8C", "#88C0D0", "#B48EAD", "#403B4252", "#81A1C1", "#88C0D0", "#A3BE8C"],
        ["Ayu Dark", "#0D1017", "#D5D8DA", "#8A9199", "#B7BDC5", "#C7D1DB", "#E6B450", "#73B7FF", "#400D1017", "#E6B450", "#73B7FF", "#7FD962"],
        ["Nord", "#626f89", "#D8DEE9", "#c8D8DEE9", "#D8DEE9", "#ECEFF4", "#88C0D0", "#D8DEE9", "#214C566A", "#88C0D0", "#88C0D0", "#88C0D0"], // A
        ["Material Ocean", "#0F111A", "#EEFFFF", "#8F93A2", "#C5C8C6", "#89DDFF", "#82AAFF", "#C792EA", "#400F111A", "#89DDFF", "#82AAFF", "#C3E88D"],
        ["Moonlight", "#222436", "#C8D3F5", "#828BB8", "#A9B8E8", "#86E1FC", "#82AAFF", "#C099FF", "#40222436", "#86E1FC", "#82AAFF", "#C3E88D"], // AA
        ["Horizon", "#1C1E26", "#D5D8DA", "#A1A1A1", "#D5D8DA", "#E95678", "#FAB795", "#B877DB", "#401C1E26", "#25B0BC", "#FAB795", "#29D398"],
        ["Monokai", "#272822", "#F8F8F2", "#A6A69C", "#F8F8F2", "#A6E22E", "#66D9EF", "#FD971F", "#40272822", "#A6E22E", "#66D9EF", "#E6DB74"],
        ["Solarized Dark", "#002B36", "#839496", "#657B83", "#93A1A1", "#B58900", "#268BD2", "#2AA198", "#40002B36", "#B58900", "#268BD2", "#859900"],
        ["Cyberpunk", "#0B0E14", "#E6E6E6", "#7A7F8B", "#C5C8C6", "#00E5FF", "#FF00A8", "#B967FF", "#400B0E14", "#00E5FF", "#FF00A8", "#A6FF00"],
        ["Synthwave", "#241B2F", "#F8F8F2", "#A89BB9", "#E6E1FF", "#FF7EDB", "#FF7EDB", "#36F9F6", "#40241B2F", "#36F9F6", "#FF7EDB", "#72F1B8"],
        ["Amethyst", "#17131F", "#E8E0F0", "#9C91A8", "#D4C5E2", "#C8A2FF", "#A970FF", "#E0AAFF", "#4017131F", "#C8A2FF", "#A970FF", "#9BE28C"],
        ["Oceanic", "#0B1E26", "#D8E6E9", "#8199A1", "#B8CDD2", "#5CCFE6", "#4DB6E8", "#89DDFF", "#400B1E26", "#5CCFE6", "#4DB6E8", "#91D67A"],
        ["Forest Night", "#101A16", "#D8E8DF", "#81968A", "#B9D0C1", "#8FCB9B", "#78C091", "#A3D9A5", "#40101A16", "#8FCB9B", "#78C091", "#C5D86D"],
        ["Coffee Dark", "#211B18", "#E8DDD5", "#A4948C", "#D1C0B7", "#D9A066", "#C78B5A", "#E0B084", "#40211B18", "#D9A066", "#C78B5A", "#A8C080"], // AA
        ["Midnight", "#10141C", "#D7DEE9", "#7F8A9A", "#B8C2D1", "#8BA4C7", "#6C8ED4", "#91B4E8", "#4010141C", "#8BA4C7", "#6C8ED4", "#91C483"],
        ["Obsidian", "#111111", "#E6E6E6", "#858585", "#C8C8C8", "#A8D08D", "#6EA8FE", "#C586C0", "#40111111", "#7FDBCA", "#6EA8FE", "#A8D08D"],
        ["Slate", "#20242B", "#D9DEE7", "#8B939F", "#BEC6D1", "#9AA8B8", "#7FA6D9", "#9BB7D4", "#4020242B", "#8FB9A8", "#7FA6D9", "#A5C982"],
        ["Arctic", "#18212B", "#E5EDF5", "#91A4B7", "#C7D5E3", "#A6D8FF", "#72B7FF", "#9AC7FF", "#4018212B", "#8ED6FF", "#72B7FF", "#9EDC9A"],
        ["Deep Purple", "#181520", "#E6DFF2", "#9288A3", "#C8BED8", "#B8A0FF", "#9B7BFF", "#D0A8FF", "#40181520", "#B8A0FF", "#9B7BFF", "#A6D98A"],
        ["Cherry", "#1E1418", "#F0DCE2", "#A98A94", "#D7BBC3", "#FF8FA3", "#FF6B81", "#FF9FB0", "#401E1418", "#FF8FA3", "#FF6B81", "#A8D88A"], // AA
        ["Ember", "#211714", "#F0DDD5", "#A99087", "#D6C0B8", "#FF9E64", "#FF8F5E", "#FFB088", "#40211714", "#FF9E64", "#FF8F5E", "#B5D66A"],
        ["Lavender", "#191722", "#E4DDF5", "#9690AA", "#CAC2DF", "#B9A7FF", "#A78BFA", "#D0B8FF", "#40191722", "#B9A7FF", "#A78BFA", "#A8D68A"],
    ]
    ...
    property color lowFocusColor: themeColors[theme][8]
    ...
    Behavior on lowFocusColor { ColorAnimation { duration: root.themeAnimationDuration; easing.type: Easing.InOutQuad } }
    ...
    // === Brightness ===
    property color brightnessIconColor: themeColors[theme][9]
    ...
    // === Volume ===
    property color volumeIconColor: themeColors[theme][10]
    ...
    // === Battery ===
    property color batteryIconColor: themeColors[theme][11]

...
Scope {
    ...
    PanelWindow {
        ...
        // Always restrict input to the visible menu shape, not the
        // transparent shadow-bleed padding around it.
        mask: midMask
        ...
        Item {
            ...
            Rectangle {
                ...
                // Follow the animated menuWidth/menuHeight directly instead
                // of snapping to 0 the instant root.show flips false, so the
                // background shrinks in sync with maxArea during close.
                ...
                // Symmetric shadow-bleed padding regardless of which edges
                // are anchored (previously only accrued on the unanchored side).
                anchors.topMargin: root.anchorTop ? root.menuTopRad : 0
                anchors.bottomMargin: root.anchorBottom ? root.menuTopRad : 0
                anchors.leftMargin: root.anchorLeft ? root.menuTopRad : 0
                anchors.rightMargin: root.anchorRight ? root.menuTopRad : 0
                ...
                Rectangle {
                    ...
                    implicitWidth: root.show ? 500 : 0
                    implicitHeight: root.show ? 500 : 0
